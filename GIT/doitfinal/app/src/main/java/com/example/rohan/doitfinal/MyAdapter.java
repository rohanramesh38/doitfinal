...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.myViewHolder> implements RecyclerView.OnItemTouchListener  {
    ...
    public void onBindViewHolder(@NonNull myViewHolder myViewHolder, int i) {
        ...
        myViewHolder.name.setText((profiles.get(i).getDomain()));
        // myViewHolder.email.setText((profiles.get(i).getEmail()));
        Picasso.get().load(profiles.get(i).getPic()).into(myViewHolder.profilePic);
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            name=(TextView) itemView.findViewById(R.id.domainlist);

            profilePic=(ImageView) itemView.findViewById(R.id.imglist);
